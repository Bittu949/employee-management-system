...
//        userService.addUser(new User(fullName, email, userName, password, role, status), confirmPassword);
...
//    public String resetPassword(@PathVariable(name = "userId") long userId,
